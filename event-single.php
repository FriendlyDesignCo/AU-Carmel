  ...
  <body class="<?php echo $currentPage; ?>">
    ...
    <article>
      ...
      <header class="page-title page-title--has-image">
        <div class="page-title__background" style="background-image: url(img/event-placeholder-733x418.jpg);"></div>
        <div class="container">
          <h1>Mosfilm Screens “Some Russian Movie” at E Street Cinema</h1>
      ...
      <div class="content-area content-area--two-col  container">
        ...
        <aside class="content-area__column content-area__column--narrow">
          ...
          <p>Lorem ipsum dolor sit email to <a href="mailto:someone@american.edu">someone@american.edu</a> or sed in semper quam, cras sit amet rutum felis. Maximum five seats per RSVP. <strong>Please RSVP no later than July 28, 2015.</strong></p>
          <a class="btn btn-secondary" href="mailto:someone@american.edu">
            <span>RSVP</span>
          </a>
