...
<html lang="en">
  ...
  <body class="<?php echo $currentPage; ?>">
    ...
    <div class="content-area content-area--two-col  container">
      ...
      <div class="content-area__column content-area__column--narrow">
        <h3 class="content-area__title">
          <span>RSVP</span>
        </h3>
        <p>Lorem ipsum dolor sit email to <a href="#">someone@american.edu</a> or sed in semper quam, cras sit amet rutum felis. Maximum five seats per RSVP. <strong>Please RSVP no later than July 28, 2015.</strong></p>
